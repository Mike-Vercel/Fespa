...
export type BadgeTone = "neutral" | "accent" | "amber" | "warning" | "rust" | "info" | "muted";
...
const TONES: Record<BadgeTone, { container: string; dot: string }> = {
  ...
  info: { container: "bg-info-soft text-info", dot: "bg-info" },
  warning: { container: "bg-warning-soft text-warning", dot: "bg-warning" },
